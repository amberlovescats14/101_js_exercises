...
const isPositiveOdd = num => (num >= 0) && num % 2 !== 0
...
const isPositiveEven = num => (num >= 0) && num % 2 === 0
...
const isNegativeOdd = num => (num < 0) && num % 2 !== 0
...
const isNegativeEven = num => (num < 0) && num % 2 === 0
...
const isMultipleOfBothThreeAndFive = num => (num % 3 === 0) && (num % 5 === 0)
...
const quotient = (a,b) => parseInt(a/b)
// 
...
const removeVowels = str => str.replace(/[a,e,i,o,u]/gi, '')
